def calculate_expected_lanes(genome_size,coverage,samples_count,is_pe,
  ...
  try:
    ...
    return output_per_unit,required_lane_per_sample,int(samples_per_lanes),samples_count,expected_lanes,expected_bases_per_sample
...
def calculate_expected_samples(genome_size,coverage,lanes_count,is_pe,
  ...
  try:
    ...
    return output_per_unit,required_lane_per_sample,int(samples_per_lanes),lanes_count,int(expected_samples),expected_bases_per_sample
  except Exception as e:
...
def calculate_expected_lanes_for_known_library(recommended_clusters,samples_count,cluster_size,
                                               is_sc,read_length,is_pe=0,max_samples=96):
  try:
